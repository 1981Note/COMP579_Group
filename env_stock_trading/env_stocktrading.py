# Reference: https://github.com/AI4Finance-Foundation/FinRL/blob/master/finrl/meta/env_stock_trading/env_stocktrading.py
...
class StockTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        self.state_space_num = state_space
        self.action_space_num = action_space
        self.tech_indicator_list = tech_indicator_list
        self.action_space = spaces.Box(low=-1, high=1, shape=(self.action_space_num,))
        self.observation_space = spaces.Box(
            low=-np.inf, high=np.inf, shape=(self.state_space_num,)
        )
    ...
    def _make_plot(self):
        ...
        plt.savefig(f"{self.results_dir}/account_value_trade_{self.episode}.png")
        plt.close()
            ...
            if (self.model_name != "") and (self.mode != ""):
                ...
                df_actions.to_csv(
                    "{}/actions_{}_{}_{}.csv".format(
                        self.results_dir, self.mode, self.model_name, self.iteration
                    )
                )
