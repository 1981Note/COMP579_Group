...
DATA_SAVE_DIR_AGENTS = "datasets_agents"
TRAINED_MODEL_DIR_AGENTS = "trained_models_agents"
TENSORBOARD_LOG_DIR_AGENTS = "tensorboard_log_agents"
RESULTS_DIR_AGENTS = "results_agents"
