# Reference: https://github.com/AI4Finance-Foundation/FinRL/blob/master/finrl/plot.py
...
def backtest_plot(
    account_value,
    baseline_start=config_agent.TRADE_START_DATE,
    baseline_end=config_agent.TRADE_END_DATE,
    baseline_ticker="^DJI",
